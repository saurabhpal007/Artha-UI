...
<div className="dark:bg-gray-800 dark:text-gray-50">
	<div className="container grid grid-cols-12 mx-auto dark:bg-gray-900">
		...
		<div className="flex flex-col p-6 col-span-full row-span-full lg:col-span-8 lg:p-40">
			<div className="flex justify-start">
				<span className="px-5 py-2 text-xs rounded-full dark:bg-green-400 dark:text-gray-900">Saving your Assets to BlockChain Technology</span>
			</div>
			<h1 className="text-4xl font-semibold pt-4">Add you brand assets</h1>
			<p className="flex-1 pt-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste, reprehenderit adipisci tempore voluptas laborum quod.</p>
...
<div className="dark:bg-gray-800 dark:text-gray-50">
	<div className="container grid grid-cols-12 mx-auto dark:bg-gray-900">
		...
		<div className="flex flex-col p-6 col-span-full row-span-full lg:col-span-8 lg:pl-40 ">
			<div className="flex justify-start">
				<span className="px-5 py-2 text-xs rounded-full dark:bg-green-400 dark:text-gray-900">Saving your Assets to BlockChain Technology</span>
			</div>
			<h1 className="text-4xl font-semibold pt-4">Add you brand assets</h1>
	...
	<div className="container px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
		<div className="grid grid-cols-12">
			<div className="pb-6 col-span-full md:pb-0 md:col-span-6">
				<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 md:justify-start">
					...
					<span className="self-center text-2xl font-semibold">Deepak App</span>
				</a>
			</div>
			...
			<div className="col-span-6 text-center md:text-left md:col-span-3">
				...
				<ul>
					<li>
						<a rel="noopener noreferrer" href="#" className="hover:dark:text-green-400">Link</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#" className="hover:dark:text-green-400">Link</a>
					</li>
		...
		<div className="grid justify-center pt-6 lg:justify-between">
			...
			<div className="flex justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13">
				<a rel="noopener noreferrer" href="#" title="Email" className="flex items-center justify-center w-10 h-10 rounded-full dark:bg-green-400 dark:text-gray-900">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
						<path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path>
						<path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path>
					</svg>
				</a>
				<a rel="noopener noreferrer" href="#" title="Twitter" className="flex items-center justify-center w-10 h-10 rounded-full dark:bg-green-400 dark:text-gray-900">
				...
				<a rel="noopener noreferrer" href="#" title="GitHub" className="flex items-center justify-center w-10 h-10 rounded-full dark:bg-green-400 dark:text-gray-900">
